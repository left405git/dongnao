...
public class HttpConnectionUtils {
	...
	public static String loadJson(String url , Map<String , String> queryParams ,Map<String , Object> bodyParams, Map<String , String> header , String method , String mediaType , Integer timeOut){
